...
|DRESSER[2]|WHEEL_DWHEEL_INTER|砂轮主轴中心与金刚滚轮圆弧顶部重合时垂直轴坐标
...
|TOOL_SET[57]||砂轮主轴中心与对刀完成后的X轴初始磨削位置重合时X轴坐标
|||
|**滚轮参数(WHEEL)**||
